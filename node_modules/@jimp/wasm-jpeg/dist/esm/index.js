...
export default function jpeg() {
    return {
        ...
        encode: async (bitmap, options = {}) => {
            const { quality, colorSpace = "srgb", arithmetic, autoSubsample, baseline, chromaQuality, chromaSubsample, optimizeCoding, progressive, quantTable, separateChromaQuality, smoothing, trellisLoops, trellisMultipass, trellisOptTable, trellisOptZero, jpegColorSpace, } = JpegOptionsSchema.parse(options);
            await initEncoder();
